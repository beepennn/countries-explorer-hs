        ...
        <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-lg shadow-md p-8 border border-gray-200/50 dark:border-gray-700/50">
          ...
          <div className="prose dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-4">Users of Countries Explorer agree to:</p>
              <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 mb-4 space-y-2">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">4. Data Sources and Accuracy</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">7. Service Availability</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">9. Contact Information</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                If you have any questions about these Terms & Conditions, please contact us at:
              </p>
              <p className="text-gray-800 dark:text-gray-200">Email: notesbybipin@gmail.com</p>
            </section>
          </div>
        </div>
      </div>
