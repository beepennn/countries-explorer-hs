    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-blue-900 dark:to-indigo-900 py-8">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-lg shadow-md p-8 border border-gray-200/50 dark:border-gray-700/50">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">About Countries Explorer</h1>
            ...
            <section className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-start gap-3">
                  <Globe className="w-6 h-6 text-blue-600 dark:text-blue-500 mt-1" />
                  <div>
                ...
                <div className="flex items-start gap-3">
                  <Search className="w-6 h-6 text-green-600 dark:text-green-500 mt-1" />
                  <div>
                ...
                <div className="flex items-start gap-3">
                  <Smartphone className="w-6 h-6 text-purple-600 dark:text-purple-500 mt-1" />
                  <div>
                ...
                <div className="flex items-start gap-3">
                  <Users className="w-6 h-6 text-orange-600 dark:text-orange-500 mt-1" />
                  <div>
              ...
              <div className="bg-gray-100 dark:bg-gray-700 p-6 rounded-lg">
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  <div className="text-center">
                    ...
                    <div className="text-sm text-gray-700 dark:text-gray-300">Next.js 14, React, TypeScript</div>
                  </div>
                  <div className="text-center">
                    <div className="font-semibold text-gray-900 dark:text-white">Styling</div>
                    <div className="text-sm text-gray-700 dark:text-gray-300">Tailwind CSS, shadcn/ui</div>
                  </div>
                  <div className="text-center">
                    <div className="font-semibold text-gray-900 dark:text-white">Data Source</div>
                    <div className="text-sm text-gray-700 dark:text-gray-300">REST Countries API</div>
                  </div>
                  <div className="text-center">
                    <div className="font-semibold text-gray-900 dark:text-white">Icons</div>
                    <div className="text-sm text-gray-700 dark:text-gray-300">Lucide React</div>
                  </div>
                  <div className="text-center">
                    <div className="font-semibold text-gray-900 dark:text-white">Themes</div>
                    <div className="text-sm text-gray-700 dark:text-gray-300">next-themes</div>
                  </div>
                  <div className="text-center">
                    <div className="font-semibold text-gray-900 dark:text-white">Deployment</div>
                    <div className="text-sm text-gray-700 dark:text-gray-300">Vercel</div>
                  </div>
                </div>
              </div>
            </section>
