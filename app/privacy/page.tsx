      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8">
          ...
          <div className="prose dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-800 dark:text-white mb-4">2. Information We Collect</h2>

              <h3 className="text-lg font-medium text-gray-700 dark:text-gray-200 mb-3">2.1 Information You Provide</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-800 dark:text-white mb-4">5. Third-Party Services</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-800 dark:text-white mb-4">6. Data Security</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-800 dark:text-white mb-4">7. Cookies and Local Storage</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-800 dark:text-white mb-4">8. Your Rights</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-800 dark:text-white mb-4">9. Children's Privacy</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-800 dark:text-white mb-4">12. Contact Us</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-4">
