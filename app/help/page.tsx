    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-100 dark:from-gray-900 dark:via-blue-900 dark:to-indigo-900 py-8">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-lg shadow-md p-8 border border-gray-200/50 dark:border-gray-700/50">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">Help & FAQ</h1>
          ...
          <div className="prose dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Features Guide</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h3 className="font-semibold text-gray-900 dark:text-white">Country Details</h3>
                  </div>
                  <ul className="text-sm text-gray-700 dark:text-gray-300 space-y-1">
                ...
                <div className="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h3 className="font-semibold text-gray-900 dark:text-white">Customization</h3>
                  </div>
                  <ul className="text-sm text-gray-700 dark:text-gray-300 space-y-1">
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Countries not loading?</h3>
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Search not working?</h3>
                  <p className="text-gray-700 dark:text-gray-300 text-sm">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Page looks broken?</h3>
                  <p className="text-gray-700 dark:text-gray-300 text-sm">
